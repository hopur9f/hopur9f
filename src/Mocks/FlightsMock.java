...
public class FlightsMock {
    ...
    /*public List getFlights(){
        ...
        Flight f1 = new Flight("Air Iceland Connect", "NY112", "Reykjavík", "Akureyri", 45, 10000, 5000, 2700, new Date(2018, 7, 1, 6, 15), new Date(2018, 7, 1, 7, 0), 500, 1000, availableSeatList );
